...
export class User1654756463890 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD role enum ('superadmin', 'admin', 'user') NOT NULL DEFAULT 'user'`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` DROP COLUMN role`);
        await queryRunner.query(`ALTER TABLE \`users\` ADD role enum ('0', '1', '2') NOT NULL DEFAULT '0'`);
    }
}
